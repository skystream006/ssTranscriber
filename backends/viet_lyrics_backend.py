...
STRIDE_LENGTH_S = 5
# STRIDE_LENGTH_S: Overlap in seconds between adjacent chunks. Larger values preserve more context
# at boundaries but repeat more work; smaller values are faster but can lose words near chunk edges.
...
# lines; smaller values split long phrases sooner for more frequent synchronized-lyrics updates.
